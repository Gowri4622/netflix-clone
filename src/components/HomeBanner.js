  ...
  return(
    <div className="home-banner">
      <div className="our-story">
        ...
        <form className="input-group" onSubmit={onSumbitHandler}>  
          <input type="text" value={email} className="form-control" placeholder="Email Address" onChange={handleChange} required />
